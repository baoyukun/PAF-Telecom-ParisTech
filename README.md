...
C'est à dire les classes [HashMapDeserializer](/rdf/src/parser/HashMapDeserializer.java),[SetDeserializer](/rdf/src/parser/SetDeserializer.java) et [ListDeserializer](/rdf/src/parser/ListDeserializer.java). Et aussi, il faut modidifier le code sur RDFUtils pour adapter ce changement.
